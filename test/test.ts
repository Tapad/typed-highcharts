...
function originalTests() {
  ...
  let animate: Highcharts.Animation = {
    duration: 200,
    easing: 'linear'
  };


  let gradient: Highcharts.Gradient = {
    linearGradient: {
      x1: 0,
      y1: 0,
      x2: 500,
  ...
  let r = new Highcharts.Renderer(div, 20, 30);
  let box = r.text('Hello', 10, 10).getBBox();

  let highChartSettings: Highcharts.Options = {
    chart: {
      width: 400,
      height: 400
    },
  ...
  let container = $('#container').highcharts(highChartSettings, (chart) => {
    chart.series[0].setVisible(true, true);
  });

  let singleYAxisOptions: Highcharts.Options = {
    yAxis: {}
  };
  let multipleYAxisOptions: Highcharts.Options = {
    yAxis: [{}, {}]
  };

  let renderToIdChart = new Highcharts.Chart('container', {
    xAxis: {},
    series: [<Highcharts.LineChartSeriesOptions>{
      data: [29.9, 71.5, 106.4, 129.2, 144.0, 176.0, 135.6, 148.5, 216.4, 194.1, 95.6, 54.4],
      type: 'line',
  ...
  let renderToElementChart = new Highcharts.Chart(div, {
    xAxis: {},
    series: [<Highcharts.LineChartSeriesOptions>{
      data: [29.9, 71.5, 106.4, 129.2, 144.0, 176.0, 135.6, 148.5, 216.4, 194.1, 95.6, 54.4],
      type: 'line',
  ...
  let createWithFunction = Highcharts.chart({
    xAxis: {},
    series: [<Highcharts.LineChartSeriesOptions>{
      data: [29.9, 71.5, 106.4, 129.2, 144.0, 176.0, 135.6, 148.5, 216.4, 194.1, 95.6, 54.4],
      type: 'line',
  ...
  let createWithFunctionRenderToId = Highcharts.chart('container', {
    xAxis: {},
    series: [<Highcharts.LineChartSeriesOptions>{
      data: [29.9, 71.5, 106.4, 129.2, 144.0, 176.0, 135.6, 148.5, 216.4, 194.1, 95.6, 54.4],
      type: 'line',
  ...
  let createWithFunctionRenderToElement = Highcharts.chart(div, {
    xAxis: {},
    series: [<Highcharts.LineChartSeriesOptions>{
      data: [29.9, 71.5, 106.4, 129.2, 144.0, 176.0, 135.6, 148.5, 216.4, 194.1, 95.6, 54.4],
      type: 'line',
...
function test_ChartOptions() {
  let emptyChartOptions: Highcharts.ChartOptions = {
    events: {},
    options3d: {},
    resetZoomButton: {}
  };

  let allValuesSet: Highcharts.ChartOptions = {
    alignTicks: false,
    animation: {
      duration: 500,
      easing: 'linear'
  ...
  $('#container').highcharts({
    chart: {
      events: {
        addSeries: function () {
          let label = (<Highcharts.ChartObject>this).renderer.label('A series was added, about to redraw chart', 100, 120)
            .attr({
...
function test_CreditsOptions() {
  let allDefaults: Highcharts.CreditsOptions = {};
...
function test_Data() {
  // all defaults
  let data: Highcharts.DataOptions = {};
...
function test_Drilldown() {
  let allDefaults: Highcharts.DrilldownOptions = {};
...
function test_Exporting() {
  let allDefaults: Highcharts.ExportingOptions = {};
...
function test_Loading() {
  let allDefaults: Highcharts.LoadingOptions = {};
...
function test_Navigation() {
  let allDefaults: Highcharts.NavigationOptions = {};
...
function test_NoData() {
  let allDefaults: Highcharts.NoDataOptions = {};
...
function test_AreaOptions() {
  let allDefaults: Highcharts.AreaChartSeriesOptions = {};
...
function test_AreaRange() {
  let allDefaults: Highcharts.AreaRangeChartSeriesOptions = {};
...
function test_Bar() {
  let allDefaults: Highcharts.BarChartSeriesOptions = {};
...
function test_BoxPlot() {
  let allDefaults: Highcharts.BoxPlotChartSeriesOptions = {};
...
function test_Bubble() {
  let allDefaults: Highcharts.BubbleChartSeriesOptions = {};
...
function test_Column() {
  let allDefaults: Highcharts.ColumnChartSeriesOptions = {};

  // same options as bar chart
}

function test_ColumnRange() {
  let allDefaults: Highcharts.ColumnRangeChartSeriesOptions = {};

  // same options as bar chart and datalabels from arearange
}

function test_ErrorBar() {
  let allDefaults: Highcharts.ErrorBarChartSeriesOptions = {};
...
function test_Funnel() {
  let allDefaults: Highcharts.FunnelChartSeriesOptions = {};
...
function test_Gauge() {
  let allDefaults: Highcharts.GaugeChartSeriesOptions = {};
...
function test_HeatMap() {
  let allDefaults: Highcharts.HeatMapSeriesOptions = {};
...
function test_Line() {
  let allDefaults: Highcharts.LineChartSeriesOptions = {};
...
function test_Pie() {
  let allDefaults: Highcharts.PieChartSeriesOptions = {};
...
function test_Polygon() {
  let allDefaults: Highcharts.PolygonChartSeriesOptions = {};
...
function test_Pyramid() {
  let allDefaults: Highcharts.PyramidChartSeriesOptions = {};
...
function test_SolidGauge() {
  let allDefaults: Highcharts.SolidGaugeChartSeriesOptions = {};
...
function test_TreeMap() {
  let allDefaults: Highcharts.TreeMapChartSeriesOptions = {};

  // allowDrillToNode
  let treeMap: Highcharts.TreeMapChartSeriesOptions = {
    type: 'treemap',
...
function test_Waterfall() {
  let allDefaults: Highcharts.WaterFallChartSeriesOptions = {};

  // partial waterfall demo
  let series: Highcharts.WaterFallChartSeriesOptions = {
...
function test_AxisOptions() {
  let allDefaults: Highcharts.AxisOptions = {};

  let axis: Highcharts.AxisOptions = {
    allowDecimals: false,
...
function test_AxisObject() {
  let axis = $('#container').highcharts().xAxis[0];
  axis.addPlotBand({
    from: 5.5,
    to: 7.5,
    color: '#FCFFC5',
...
function test_ChartObject() {
  ...
  let object = chart.get('axisIdOrSeriesIdOrPointId');
  let svg1 = chart.getSVG();
  let svg2 = chart.getSVG(<Highcharts.Options>{});
  let selectedPoints = chart.getSelectedPoints();
  let selectedSeries = chart.getSelectedSeries();
  chart.hideLoading();
  ...
  let firstXAxis = chart.xAxis[0];
  let firstYAxis = chart.yAxis[0];
  let legend = chart.legend;
}

function test_ElementObject() {
  let renderer = new Highcharts.Renderer($('#container')[0], 400, 400);
  let group = renderer.g().add();
  renderer
    .circle(200, 150, 100)
    .attr({
      fill: '#FCFFC5',
  ...
  let styledText = renderer
    ...
    .add();
  let bbox = styledText.getBBox();
  styledText.on('click', () => {});
  group.toFront();
}

function test_PointObject() {
  let point = <Highcharts.PointObject>$('#container').highcharts().get('point1');
  let category = point.category;
  let percentage = point.percentage;
  point.index;
  point.remove();
  point.remove(false);
...
function test_RendererObject() {
  let renderer = $('#container').highcharts().renderer;
...
function test_SeriesObject() {
  let series = <Highcharts.SeriesObject>$('#container').highcharts().get('series1');
  series.addPoint(0);
  series.addPoint([0, 0]);
  series.addPoint({});
  ...
  series.select();
  series.select(true);
  let isSelected = series.selected;
...
function test_LegendObject() {
  let legend = $('#container').highcharts().legend;
  legend.update({});
  legend.update({}, false);
}
